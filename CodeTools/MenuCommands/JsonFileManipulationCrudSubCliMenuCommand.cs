...
public sealed class JsonFileManipulationCrudSubCliMenuCommand : CliMenuCommand
{
    ...
    public JsonFileManipulationCrudSubCliMenuCommand(ParametersManager parametersManager, string fileName) : base(
        fileName, EMenuAction.LoadSubMenu)
    {
    ...
    public override CliMenuSet GetSubMenu()
    {
        ...
        jsonFileManipulationCrudSubMenuSet.AddMenuItem(new RunJsonEditCliMenuCommand(Name));
